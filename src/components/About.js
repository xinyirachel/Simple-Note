  ...
  return (
    <div>
        ...
        <div className="section-center">
            ...
            <div>
            Simple Note is a rather simplistic application that allows notes to be added and deleted, as well as printed. The app also include some utilities for note-taking on Tools page.
